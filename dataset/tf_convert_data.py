...
from dataset import medicalimage_to_tfrecords
...
def main(_):
    ...
    if FLAGS.dataset_name == 'medicalimage':
        if not FLAGS.attribute_flag:
            print('run')
            medicalimage_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name,
                                          stage_name=FLAGS.stage_name)
        else:
            print('run_with_attributes')
            medicalimage_to_tfrecords.run_with_attributes(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name,
                                                          stage_name=FLAGS.stage_name)
