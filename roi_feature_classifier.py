...
def load_feature(dataset_dir='/home/dl-box/ld/Documents/datasets/IEEEonMedicalImage_Splited/JPG/0'):
    ...
    def _load_label(dataset_dir, stage_name):
        slice_names = os.listdir(os.path.join(dataset_dir, stage_name))
        labels = []
        for slice_name in slice_names:
            labels.append(int(slice_name[-1]))
    ...
    train_npy_path = os.path.join(dataset_dir, 'train.npy')
    val_npy_path = os.path.join(dataset_dir, 'val.npy')
    test_npy_path = os.path.join(dataset_dir, 'test.npy')
    train_labels, train_slice_names = _load_label(dataset_dir, 'train')
    val_labels, val_slice_names = _load_label(dataset_dir, 'val')
    test_labels, test_slice_names = _load_label(dataset_dir, 'test')
